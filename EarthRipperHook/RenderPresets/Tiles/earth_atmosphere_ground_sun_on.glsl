...
void main()
{
	// The center of the texture provides us with a stable, semi-random color that's usually easy enough to distinguish
	// from neighboring tiles.
	gl_FragColor = texture2D(groundTexture, vec2(0.5, 0.5));
